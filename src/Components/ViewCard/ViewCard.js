            ...
            <figure class="snip1527">
              <div class="image"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/pr-sample23.jpg" alt="pr-sample23" /></div>
               <figcaption>
                 ...
                 <div class="container d-flex float-right justify-content-end"><button class="btn btn-warning btn-sm text-monospace bg-danger border rounded border-dark shadow d-block" type="button">Button</button></div>
                 </figcaption>
              <a href="#"></a>
            </figure>
